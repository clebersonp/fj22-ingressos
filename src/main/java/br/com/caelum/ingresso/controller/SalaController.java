...
public class SalaController {
	...
	@GetMapping({ "/admin/sala", "/admin/sala/{id}" }) public ModelAndView form(
			@PathVariable("id") Optional<Integer> id, Sala sala) {
	...
	public ModelAndView listaSessoes(@PathVariable("id") Integer id) {
		...
		view.addObject("sessoes", sessaoDao.buscaoSessoesDaSala(sala));
		return view;
	}
